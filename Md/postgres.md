...
このデータベースクラスタが無いと、PostgreSQLサーバは起動できない。※１
具体的な中身は、データベースの設定ファイルとかログとかいろいろ入ってる。主なものは以下の通り。
...
#(c/t/pがそれぞれカスタム/tar/テキストの順。指定しなければスクリプト形式になる)
$ pg_dump -Fc 以下略...
