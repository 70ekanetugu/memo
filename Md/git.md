...
　　　　\
         E--F (origin/feature)
```
上図ブランチの通り、リモートトラッキングブランチはあくまでリモートリポジトリのブランチを参照しているものである。このリモートブランチをリモートトラッキングブランチに反映させるのがfetch操作であり、この反映を作業ツリーが参照しているローカルブランチに反映させるのがmerge操作である。
